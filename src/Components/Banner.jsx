  ...
  return (
    <>
      <div className=" w-full flex top-0 left-0 justify-center">
        <div className="w-full lg:max-w-7xl 2xl:max-w-none mx-auto">
          <div className="relative w-full overflow-hidden bg-black rounded-none 2xl:rounded-2xl shadow-2xl">
            <div
